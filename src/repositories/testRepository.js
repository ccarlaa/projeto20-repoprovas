...
function createTest(newTest) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_js_1["default"].tests.create({ data: newTest })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getTestsByDiscipline() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_js_1["default"].terms.findMany({
                        include: {
                            Disciplines: {
                                include: {
                                    TeachersDisciplines: {
...
function getTestsByTeacher() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_js_1["default"].teachersDisciplines.findMany({
                        where: {},
                        include: {
                            Teachers: {},
                            Disciplines: { include: {
